...
RageUI.Settings = {
    ...
    Audio = {
        ...
        RageUI = {
            UpDown = {
                audioName = "DLC_APT_Apartment_SoundSet",
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Header) then
            ...
            if (CurrentMenu.Display.Glare) then
                ...
                local Glareheight = RageUI.Settings.Items.Title.Background.Height
                ---@type number
                local GlareX = CurrentMenu.X / 1920 + (CurrentMenu.SafeZoneSize.X / (64.98 - (CurrentMenu.WidthOffset * 0.065731)))
                ---@type number
