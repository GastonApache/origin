...
function ArriveTenue()
RequestModel(GetHashKey("mp_m_freemode_01"))
    while not HasModelLoaded(GetHashKey("mp_m_freemode_01")) do Wait(10) end
    RequestModel(GetHashKey("mp_f_freemode_01"))
    while not HasModelLoaded(GetHashKey("mp_f_freemode_01")) do Wait(10) end
    SetPlayerModel(PlayerId(), GetHashKey("mp_m_freemode_01"))
    TriggerEvent("skinchanger:change", 'sexe')
    TriggerEvent('skinchanger:getSkin', function(skin)
        TriggerEvent('skinchanger:loadClothes', skin, defaultHomme)
    --end)
    TriggerEvent("skinchanger:change", 'face', 0)
    TriggerEvent("skinchanger:change", 'hair_1', 0)
    TriggerEvent("skinchanger:change", 'beard_2', 0)
    --new test
    DisplayRadar(true)
...
AddEventHandler('esx:playerLoaded', function(xPlayer, isNew, skin)
	...
	if Config.Multichar then
		...
		exports.es_extended:spawnPlayer({
			...
			print("^6[Position]^7 ^5[X]"..ESX.PlayerData.coords.x.."^7 ^3[Y]"..ESX.PlayerData.coords.y.."^7 ^2[Z]"..ESX.PlayerData.coords.z.." ^6[Spawn-Players]^7")
