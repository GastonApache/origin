local Grid = {
	Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 0.0, Width = 431.0, Height = 200.0 },
	Grid = { X = 0.0, Y = 4.0, Width = 431.0, Height = 200.0 },
	Text = {
		Top = { X = 215.5, Y = 15.0, Scale = 0.35 },
		Bottom = { X = 215.5, Y = 250.0, Scale = 0.35 },
		Left = { X = 57.75, Y = 130.0, Scale = 0.35 },
		Right = { X = 373.25, Y = 130.0, Scale = 0.35 }
	}
}

function RageUI.TexturePanel(Txd, Txn, Height)
	local CurrentMenu = RageUI.CurrentMenu

	if CurrentMenu then
		local CustomHeight = Height or Grid.Background.Height
		RenderSprite(Grid.Background.Dictionary, Grid.Background.Texture, CurrentMenu.X, CurrentMenu.Y + Grid.Background.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, Grid.Background.Width + CurrentMenu.WidthOffset, CustomHeight, 0.0, 255, 255, 255, 255)
		RenderSprite(Txd, Txn, CurrentMenu.X , CurrentMenu.Y + Grid.Background.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, Grid.Background.Width + CurrentMenu.WidthOffset, CustomHeight)
		RageUI.ItemOffset = RageUI.ItemOffset + CustomHeight + Grid.Background.Y
	end
end
